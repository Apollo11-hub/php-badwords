...
$lughezza_testo = strlen($testo_lorem);

$badword = $_GET['badw'];

$testo_lorem_censurato = str_replace($badword, '<strong> *** </strong>' , $testo_lorem);
...
<body>
  <h1>Questo testo lorem non è censurato ed è lungo <?php echo $lughezza_testo ?> caratteri</h1>
  <p> <?php echo $testo_lorem ?></p>
  <h2>Questo testo lorem è censurato ed è lungo <?php echo $lughezza_testo ?> caratteri </h2>
